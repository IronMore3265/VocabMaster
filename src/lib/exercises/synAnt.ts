...
import { pickDistractors, shortDefinition } from './distractors';
 ...
 */
export function makeSynAntItems(words: readonly WordRow[], seed: number): McqItem[] {
...
function synonymItem(word: WordRow, pool: readonly WordRow[], rng: () => number): McqItem | null {
...
function antonymItem(word: WordRow, pool: readonly WordRow[], rng: () => number): McqItem | null {
